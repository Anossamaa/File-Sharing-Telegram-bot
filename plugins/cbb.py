...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        ...
        await query.message.edit_text(
            text=f"👋 {query.from_user.username}\n\n🎖️ Available Plans :\n\n● {PRICE1} rs For Mom son Indian and foreign all kind\n\n● {PRICE2} rs For Brother sister real indian and foreign\n\n● {PRICE3} rs For Blackmail snapgod to do dirty Stuff\n\n● {PRICE4} rs For Force r@pe and torture all type\n\n● {PRICE5} rs For Cimpi all kind all age chick\n\n\n💵 UPI ID -  {UPI_ID}\n\n(Tap to copy UPI Id)\n\n\n📸 QR - ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ ({UPI_IMAGE_URL})\n\n♻️ If payment is not getting sent on above given QR code then inform admin, he will give you new QR code\n\n\n‼️ Must Send Screenshot after payment",
            disable_web_page_preview=True,
            reply_markup = InlineKeyboardMarkup(
                [   
                    [
